...
The timeline parameters described above are configured in the \code{[timeline]} block of the aircraft spec (\code{TimelineSpec} in \code{src/sim/Aircraft/Spec.jl}, parsed by \code{src/sim/Aircraft/toml/Sections/Timeline.jl}):
