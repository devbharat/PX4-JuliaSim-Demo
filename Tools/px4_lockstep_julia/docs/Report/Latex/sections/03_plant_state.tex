...
The integrator described in \cref{sec:integrators} is selected in the \code{[plant]} block (\code{PlantSpec.integrator}, parsed by \code{_parse\_integrator} in \code{src/sim/Aircraft/TOMLIO.jl}). The parser accepts either a string shorthand:
