...
\begin{itemize}[leftmargin=*,itemsep=2pt]
  \item \code{cell\_asset} / \code{pack\_asset}: path to a \code{meta.toml} describing an asset; paths are resolved relative to the spec file (\code{_resolve\_path} in \code{src/sim/Aircraft/toml/Utils.jl}).
